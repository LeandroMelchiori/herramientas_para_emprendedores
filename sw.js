...
const PRECACHE = [
  ...
  '/modules/combinadordecolores/events.js',
  ...
  '/modules/registrodeventas/history.css',
  '/modules/registrodeventas/app.js',
  '/modules/registrodeventas/sales-domain.js',
